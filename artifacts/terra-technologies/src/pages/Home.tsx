...
export default function Home() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#f5f5f3", color: "#111", minHeight: "100vh" }}>
      ...
      {/* REVIEWS */}
      <section style={{ padding: "60px 0", background: "#f5f5f3", overflow: "hidden" }}>
        <div style={{ padding: "0 7%", marginBottom: 32, display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          <div>
            <h2 style={{ fontSize: "2.5rem", letterSpacing: "-2px", marginBottom: 8, fontWeight: 700 }}>
              What Our Customers Say
            </h2>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{ display: "flex", gap: 2 }}>
                {[1,2,3,4,5].map(i => (
                  <svg key={i} width="20" height="20" viewBox="0 0 24 24" fill="#FBBC04"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>
                ))}
              </div>
              <span style={{ fontWeight: 700, fontSize: "1.05rem" }}>5.0</span>
          ...
          {[
            {
              name: "Sarah M.",
              date: "2 weeks ago",
              text: "Absolutely fantastic service! They ground out three large stumps in our backyard quickly and cleanly. Pricing was exactly what was quoted — no surprises. Will definitely call them again.",
            },
            {
              name: "Tom H.",
              date: "1 month ago",
              text: "Professional, punctual, and fair pricing. They tackled a massive oak stump that had been an eyesore for years. The area was left clean and ready to landscape. Highly recommend.",
            },
            {
              name: "Jessica R.",
              date: "1 month ago",
              text: "I got several quotes and Stephenson was the most transparent and reasonable. The crew was friendly and the work was done in under an hour. Backyard looks so much better now!",
            },
            {
              name: "Mike D.",
              date: "2 months ago",
              text: "Great local business. Called and got a response same day. Showed up on time, did exactly what was discussed, and cleaned up after themselves. Five stars without hesitation.",
            },
            {
              name: "Linda K.",
              date: "2 months ago",
              text: "Very happy with the results. Had two stumps removed in tight spots near fencing — they handled it carefully without any damage. Reasonable price and great communication throughout.",
            },
            {
              name: "Dave P.",
              date: "3 months ago",
              text: "Used their Full Restoration package after removing a large tree. They ground the stump, cleared the debris, and added topsoil and seed. Lawn looks perfect. Worth every penny.",
            },
          ].map((review) => (
            <div
              key={review.name}
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "0.78rem", color: "#999" }}>{review.date}</div>
                  </div>
                </div>
                {/* Google G */}
              ...
              <div style={{ display: "flex", gap: 2 }}>
                {[1,2,3,4,5].map(i => (
                  <svg key={i} width="16" height="16" viewBox="0 0 24 24" fill="#FBBC04"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>
                ))}
              </div>
